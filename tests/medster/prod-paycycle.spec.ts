...
test('test', async ({ page }) => {
  ...
  await page.getByRole('row', { name: 'Dec 2023 CA$0.00 OPEN Edit' }).locator('span').click();
  ...
  await page.getByRole('button', { name: 'Add Transaction' }).click();
  await page.locator('#provider').selectOption('945e2950-2cb3-4fa3-8c14-510d6755d77f');
  ...
  await page.getByRole('button', { name: 'Create' }).click();
  await page.getByRole('button', { name: 'Add Transaction' }).click();
  await page.locator('#provider').selectOption('fc4444d2-0914-4abc-a4af-4c97aeeae7eb');
  await page.getByPlaceholder('Solo OHIP').click();
